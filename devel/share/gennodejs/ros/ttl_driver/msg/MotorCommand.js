...
class MotorCommand {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.uint32(obj.params, buffer, bufferOffset, null);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.params = _arrayDeserializer.uint32(buffer, bufferOffset, null)
    return data;
  }
