...
(cl:defclass <SoftwareVersion> (roslisp-msg-protocol:ros-message)
  ((rpi_image_version
   ...
   (ros_niryo_robot_version
    :reader ros_niryo_robot_version
    :initarg :ros_niryo_robot_version
    :type cl:string
    :initform "")
   (robot_version
    :reader robot_version
    :initarg :robot_version
    :type cl:string
    :initform "")
   (motor_names
    :reader motor_names
...
(cl:defmethod cl:initialize-instance :after ((m <SoftwareVersion>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SoftwareVersion)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name niryo_robot_msgs-msg:<SoftwareVersion> is deprecated: use niryo_robot_msgs-msg:SoftwareVersion instead.")))

(cl:ensure-generic-function 'rpi_image_version-val :lambda-list '(m))
(cl:defmethod rpi_image_version-val ((m <SoftwareVersion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_msgs-msg:rpi_image_version-val is deprecated.  Use niryo_robot_msgs-msg:rpi_image_version instead.")
  (rpi_image_version m))

(cl:ensure-generic-function 'ros_niryo_robot_version-val :lambda-list '(m))
(cl:defmethod ros_niryo_robot_version-val ((m <SoftwareVersion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_msgs-msg:ros_niryo_robot_version-val is deprecated.  Use niryo_robot_msgs-msg:ros_niryo_robot_version instead.")
  (ros_niryo_robot_version m))

(cl:ensure-generic-function 'robot_version-val :lambda-list '(m))
(cl:defmethod robot_version-val ((m <SoftwareVersion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_msgs-msg:robot_version-val is deprecated.  Use niryo_robot_msgs-msg:robot_version instead.")
  (robot_version m))
...
(cl:defmethod stepper_firmware_versions-val ((m <SoftwareVersion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_msgs-msg:stepper_firmware_versions-val is deprecated.  Use niryo_robot_msgs-msg:stepper_firmware_versions instead.")
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SoftwareVersion>) ostream)
  ...
  (cl:let ((__ros_str_len (cl:length (cl:slot-value msg 'ros_niryo_robot_version))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'ros_niryo_robot_version))
  (cl:let ((__ros_str_len (cl:length (cl:slot-value msg 'robot_version))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'robot_version))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SoftwareVersion>) istream)
  "Deserializes a message object of type '<SoftwareVersion>"
    ...
    (cl:let ((__ros_str_len 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'ros_niryo_robot_version) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'ros_niryo_robot_version) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
    (cl:let ((__ros_str_len 0))
      (cl:setf (cl:ldb (cl:byte 8 0) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'robot_version) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'robot_version) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SoftwareVersion>)))
  ...
  "6d753e36564fa618802ffe450e4bbdd2")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SoftwareVersion)))
  "Returns md5sum for a message object of type 'SoftwareVersion"
  "6d753e36564fa618802ffe450e4bbdd2")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SoftwareVersion>)))
  ...
  (cl:format cl:nil "string rpi_image_version~%string ros_niryo_robot_version~%string robot_version~%~%string[] motor_names~%string[] stepper_firmware_versions~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SoftwareVersion)))
  "Returns full string definition for message of type 'SoftwareVersion"
  (cl:format cl:nil "string rpi_image_version~%string ros_niryo_robot_version~%string robot_version~%~%string[] motor_names~%string[] stepper_firmware_versions~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <SoftwareVersion>))
  (cl:+ 0
     ...
     4 (cl:length (cl:slot-value msg 'ros_niryo_robot_version))
     4 (cl:length (cl:slot-value msg 'robot_version))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <SoftwareVersion>))
  ...
  (cl:list 'SoftwareVersion
    ...
    (cl:cons ':ros_niryo_robot_version (ros_niryo_robot_version msg))
    (cl:cons ':robot_version (robot_version msg))
