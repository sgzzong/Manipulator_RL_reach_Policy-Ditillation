...
(cl:defclass <HardwareStatus> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (hardware_version
    ...
    :initform "")
   (hardware_state
    :reader hardware_state
    :initarg :hardware_state
    :type cl:fixnum
    :initform 0)
   (connection_up
   ...
   (hardware_errors_message
    :reader hardware_errors_message
    :initarg :hardware_errors_message
    :type (cl:vector cl:string)
   :initform (cl:make-array 0 :element-type 'cl:string :initial-element "")))
)
...
(cl:defmethod cl:initialize-instance :after ((m <HardwareStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HardwareStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name niryo_robot_msgs-msg:<HardwareStatus> is deprecated: use niryo_robot_msgs-msg:HardwareStatus instead.")))
...
(cl:defmethod rpi_temperature-val ((m <HardwareStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_msgs-msg:rpi_temperature-val is deprecated.  Use niryo_robot_msgs-msg:rpi_temperature instead.")
  (rpi_temperature m))

(cl:ensure-generic-function 'hardware_version-val :lambda-list '(m))
(cl:defmethod hardware_version-val ((m <HardwareStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_msgs-msg:hardware_version-val is deprecated.  Use niryo_robot_msgs-msg:hardware_version instead.")
  (hardware_version m))

(cl:ensure-generic-function 'hardware_state-val :lambda-list '(m))
(cl:defmethod hardware_state-val ((m <HardwareStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_msgs-msg:hardware_state-val is deprecated.  Use niryo_robot_msgs-msg:hardware_state instead.")
  (hardware_state m))

(cl:ensure-generic-function 'connection_up-val :lambda-list '(m))
(cl:defmethod connection_up-val ((m <HardwareStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_msgs-msg:connection_up-val is deprecated.  Use niryo_robot_msgs-msg:connection_up instead.")
  (connection_up m))

(cl:ensure-generic-function 'error_message-val :lambda-list '(m))
(cl:defmethod error_message-val ((m <HardwareStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_msgs-msg:error_message-val is deprecated.  Use niryo_robot_msgs-msg:error_message instead.")
  (error_message m))

(cl:ensure-generic-function 'calibration_needed-val :lambda-list '(m))
(cl:defmethod calibration_needed-val ((m <HardwareStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_msgs-msg:calibration_needed-val is deprecated.  Use niryo_robot_msgs-msg:calibration_needed instead.")
...
(cl:defmethod calibration_in_progress-val ((m <HardwareStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_msgs-msg:calibration_in_progress-val is deprecated.  Use niryo_robot_msgs-msg:calibration_in_progress instead.")
...
(cl:defmethod motor_names-val ((m <HardwareStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_msgs-msg:motor_names-val is deprecated.  Use niryo_robot_msgs-msg:motor_names instead.")
  (motor_names m))

(cl:ensure-generic-function 'motor_types-val :lambda-list '(m))
(cl:defmethod motor_types-val ((m <HardwareStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_msgs-msg:motor_types-val is deprecated.  Use niryo_robot_msgs-msg:motor_types instead.")
  (motor_types m))

(cl:ensure-generic-function 'temperatures-val :lambda-list '(m))
(cl:defmethod temperatures-val ((m <HardwareStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_msgs-msg:temperatures-val is deprecated.  Use niryo_robot_msgs-msg:temperatures instead.")
  (temperatures m))

(cl:ensure-generic-function 'voltages-val :lambda-list '(m))
(cl:defmethod voltages-val ((m <HardwareStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_msgs-msg:voltages-val is deprecated.  Use niryo_robot_msgs-msg:voltages instead.")
  (voltages m))

(cl:ensure-generic-function 'hardware_errors-val :lambda-list '(m))
(cl:defmethod hardware_errors-val ((m <HardwareStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_msgs-msg:hardware_errors-val is deprecated.  Use niryo_robot_msgs-msg:hardware_errors instead.")
  (hardware_errors m))

(cl:ensure-generic-function 'hardware_errors_message-val :lambda-list '(m))
(cl:defmethod hardware_errors_message-val ((m <HardwareStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_msgs-msg:hardware_errors_message-val is deprecated.  Use niryo_robot_msgs-msg:hardware_errors_message instead.")
  (hardware_errors_message m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<HardwareStatus>)))
    "Constants for message type '<HardwareStatus>"
  '((:ERROR . -1)
    (:NORMAL . 0)
    (:DEBUG . 1)
    (:REBOOT . 2))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <HardwareStatus>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'hardware_state)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 256) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    )
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'calibration_needed) 1 0)) ostream)
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'hardware_errors_message))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (cl:let ((__ros_str_len (cl:length ele)))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) ele))
   (cl:slot-value msg 'hardware_errors_message))
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <HardwareStatus>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'hardware_state) (cl:if (cl:< unsigned 128) unsigned (cl:- unsigned 256))))
    ...
    (cl:setf (cl:slot-value msg 'calibration_needed) (cl:not (cl:zerop (cl:read-byte istream))))
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'hardware_errors_message) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'hardware_errors_message)))
    (cl:dotimes (i __ros_arr_len)
    (cl:let ((__ros_str_len 0))
      (cl:setf (cl:ldb (cl:byte 8 0) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) __ros_str_len) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<HardwareStatus>)))
  ...
  "9ebcaa8958a2bb480c482b67e9dd2b63")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'HardwareStatus)))
  "Returns md5sum for a message object of type 'HardwareStatus"
  "9ebcaa8958a2bb480c482b67e9dd2b63")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <HardwareStatus>))
  (cl:+ 0
     ...
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'hardware_errors_message) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4 (cl:length ele))))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <HardwareStatus>))
  ...
  (cl:list 'HardwareStatus
    ...
    (cl:cons ':hardware_state (hardware_state msg))
    ...
    (cl:cons ':hardware_errors_message (hardware_errors_message msg))
))
