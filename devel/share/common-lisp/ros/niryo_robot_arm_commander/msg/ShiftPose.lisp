...
(cl:defmethod cl:initialize-instance :after ((m <ShiftPose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ShiftPose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name niryo_robot_arm_commander-msg:<ShiftPose> is deprecated: use niryo_robot_arm_commander-msg:ShiftPose instead.")))

(cl:ensure-generic-function 'axis_number-val :lambda-list '(m))
(cl:defmethod axis_number-val ((m <ShiftPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_arm_commander-msg:axis_number-val is deprecated.  Use niryo_robot_arm_commander-msg:axis_number instead.")
  (axis_number m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <ShiftPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_arm_commander-msg:value-val is deprecated.  Use niryo_robot_arm_commander-msg:value instead.")
  (value m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ShiftPose>)))
  ...
  "niryo_robot_arm_commander/ShiftPose")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ShiftPose)))
  "Returns string type for a message object of type 'ShiftPose"
  "niryo_robot_arm_commander/ShiftPose")
