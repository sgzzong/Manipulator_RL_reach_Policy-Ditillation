...
(cl:defmethod cl:initialize-instance :after ((m <ConveyorFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConveyorFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name conveyor_interface-msg:<ConveyorFeedback> is deprecated: use conveyor_interface-msg:ConveyorFeedback instead.")))

(cl:ensure-generic-function 'conveyor_id-val :lambda-list '(m))
(cl:defmethod conveyor_id-val ((m <ConveyorFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conveyor_interface-msg:conveyor_id-val is deprecated.  Use conveyor_interface-msg:conveyor_id instead.")
  (conveyor_id m))

(cl:ensure-generic-function 'connection_state-val :lambda-list '(m))
(cl:defmethod connection_state-val ((m <ConveyorFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conveyor_interface-msg:connection_state-val is deprecated.  Use conveyor_interface-msg:connection_state instead.")
  (connection_state m))

(cl:ensure-generic-function 'running-val :lambda-list '(m))
(cl:defmethod running-val ((m <ConveyorFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conveyor_interface-msg:running-val is deprecated.  Use conveyor_interface-msg:running instead.")
  (running m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <ConveyorFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conveyor_interface-msg:speed-val is deprecated.  Use conveyor_interface-msg:speed instead.")
  (speed m))

(cl:ensure-generic-function 'direction-val :lambda-list '(m))
(cl:defmethod direction-val ((m <ConveyorFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conveyor_interface-msg:direction-val is deprecated.  Use conveyor_interface-msg:direction instead.")
  (direction m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConveyorFeedback>)))
  ...
  "conveyor_interface/ConveyorFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConveyorFeedback)))
  "Returns string type for a message object of type 'ConveyorFeedback"
  "conveyor_interface/ConveyorFeedback")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ConveyorFeedback>)))
  ...
  (cl:format cl:nil "~%#Conveyor id ( either 12 or 18)~%uint8 conveyor_id~%#Conveyor Connection state ( if it is enabled) ~%bool connection_state~%# Conveyor Controls state : ON or OFF~%bool running~%# Conveyor Speed ( 1-> 100 %)~%int16 speed~%# Conveyor direction ( backward or forward)~%int8 direction~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ConveyorFeedback)))
  "Returns full string definition for message of type 'ConveyorFeedback"
  (cl:format cl:nil "~%#Conveyor id ( either 12 or 18)~%uint8 conveyor_id~%#Conveyor Connection state ( if it is enabled) ~%bool connection_state~%# Conveyor Controls state : ON or OFF~%bool running~%# Conveyor Speed ( 1-> 100 %)~%int16 speed~%# Conveyor direction ( backward or forward)~%int8 direction~%~%~%"))
