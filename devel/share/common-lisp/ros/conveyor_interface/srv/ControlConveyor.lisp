...
(cl:defmethod cl:initialize-instance :after ((m <ControlConveyor-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ControlConveyor-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name conveyor_interface-srv:<ControlConveyor-request> is deprecated: use conveyor_interface-srv:ControlConveyor-request instead.")))
...
(cl:defmethod control_on-val ((m <ControlConveyor-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conveyor_interface-srv:control_on-val is deprecated.  Use conveyor_interface-srv:control_on instead.")
  (control_on m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <ControlConveyor-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conveyor_interface-srv:speed-val is deprecated.  Use conveyor_interface-srv:speed instead.")
  (speed m))

(cl:ensure-generic-function 'direction-val :lambda-list '(m))
(cl:defmethod direction-val ((m <ControlConveyor-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader conveyor_interface-srv:direction-val is deprecated.  Use conveyor_interface-srv:direction instead.")
  (direction m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ControlConveyor-request>)))
  ...
  "conveyor_interface/ControlConveyorRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ControlConveyor-request)))
  "Returns string type for a service object of type 'ControlConveyor-request"
  "conveyor_interface/ControlConveyorRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ControlConveyor-request>)))
  ...
  "1a12d96c98fd71f849fe51970dc7ea3b")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ControlConveyor-request)))
  "Returns md5sum for a message object of type 'ControlConveyor-request"
  "1a12d96c98fd71f849fe51970dc7ea3b")
...
(cl:defmethod cl:initialize-instance :after ((m <ControlConveyor-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ControlConveyor-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name conveyor_interface-srv:<ControlConveyor-response> is deprecated: use conveyor_interface-srv:ControlConveyor-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ControlConveyor-response>)))
  ...
  "conveyor_interface/ControlConveyorResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ControlConveyor-response)))
  "Returns string type for a service object of type 'ControlConveyor-response"
  "conveyor_interface/ControlConveyorResponse")
