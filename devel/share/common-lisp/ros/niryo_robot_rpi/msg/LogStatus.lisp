...
(cl:defmethod cl:initialize-instance :after ((m <LogStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LogStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name niryo_robot_rpi-msg:<LogStatus> is deprecated: use niryo_robot_rpi-msg:LogStatus instead.")))
