...
(cl:defmethod cl:initialize-instance :after ((m <ObjDetection-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjDetection-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name niryo_robot_vision-srv:<ObjDetection-request> is deprecated: use niryo_robot_vision-srv:ObjDetection-request instead.")))

(cl:ensure-generic-function 'obj_type-val :lambda-list '(m))
(cl:defmethod obj_type-val ((m <ObjDetection-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_vision-srv:obj_type-val is deprecated.  Use niryo_robot_vision-srv:obj_type instead.")
  (obj_type m))

(cl:ensure-generic-function 'obj_color-val :lambda-list '(m))
(cl:defmethod obj_color-val ((m <ObjDetection-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_vision-srv:obj_color-val is deprecated.  Use niryo_robot_vision-srv:obj_color instead.")
  (obj_color m))

(cl:ensure-generic-function 'workspace_ratio-val :lambda-list '(m))
(cl:defmethod workspace_ratio-val ((m <ObjDetection-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_vision-srv:workspace_ratio-val is deprecated.  Use niryo_robot_vision-srv:workspace_ratio instead.")
  (workspace_ratio m))

(cl:ensure-generic-function 'ret_image-val :lambda-list '(m))
(cl:defmethod ret_image-val ((m <ObjDetection-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_vision-srv:ret_image-val is deprecated.  Use niryo_robot_vision-srv:ret_image instead.")
  (ret_image m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ObjDetection-request>)))
  ...
  "9e4efd6b216b3412a5d44ee05962fab9")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ObjDetection-request)))
  "Returns md5sum for a message object of type 'ObjDetection-request"
  "9e4efd6b216b3412a5d44ee05962fab9")
...
(cl:defclass <ObjDetection-response> (roslisp-msg-protocol:ros-message)
  ((status
   ...
   (obj_pose
    :reader obj_pose
    :initarg :obj_pose
    :type niryo_robot_msgs-msg:ObjectPose
    :initform (cl:make-instance 'niryo_robot_msgs-msg:ObjectPose))
   (obj_type
    :reader obj_type
    :initarg :obj_type
    :type cl:string
...
(cl:defmethod cl:initialize-instance :after ((m <ObjDetection-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjDetection-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name niryo_robot_vision-srv:<ObjDetection-response> is deprecated: use niryo_robot_vision-srv:ObjDetection-response instead.")))
...
(cl:defmethod obj_pose-val ((m <ObjDetection-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_vision-srv:obj_pose-val is deprecated.  Use niryo_robot_vision-srv:obj_pose instead.")
  (obj_pose m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ObjDetection-response>)))
  ...
  (cl:format cl:nil "int32 status~%~%niryo_robot_msgs/ObjectPose obj_pose~%~%string obj_type~%string obj_color~%~%sensor_msgs/CompressedImage img~%~%~%================================================================================~%MSG: niryo_robot_msgs/ObjectPose~%float64 x~%float64 y~%float64 z~%~%float64 roll~%float64 pitch~%float64 yaw~%~%================================================================================~%MSG: sensor_msgs/CompressedImage~%# This message contains a compressed image~%~%Header header        # Header timestamp should be acquisition time of image~%                     # Header frame_id should be optical frame of camera~%                     # origin of frame should be optical center of camera~%                     # +x should point to the right in the image~%                     # +y should point down in the image~%                     # +z should point into to plane of the image~%~%string format        # Specifies the format of the data~%                     #   Acceptable values:~%                     #     jpeg, png~%uint8[] data         # Compressed image buffer~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ObjDetection-response)))
  "Returns full string definition for message of type 'ObjDetection-response"
  (cl:format cl:nil "int32 status~%~%niryo_robot_msgs/ObjectPose obj_pose~%~%string obj_type~%string obj_color~%~%sensor_msgs/CompressedImage img~%~%~%================================================================================~%MSG: niryo_robot_msgs/ObjectPose~%float64 x~%float64 y~%float64 z~%~%float64 roll~%float64 pitch~%float64 yaw~%~%================================================================================~%MSG: sensor_msgs/CompressedImage~%# This message contains a compressed image~%~%Header header        # Header timestamp should be acquisition time of image~%                     # Header frame_id should be optical frame of camera~%                     # origin of frame should be optical center of camera~%                     # +x should point to the right in the image~%                     # +y should point down in the image~%                     # +z should point into to plane of the image~%~%string format        # Specifies the format of the data~%                     #   Acceptable values:~%                     #     jpeg, png~%uint8[] data         # Compressed image buffer~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
