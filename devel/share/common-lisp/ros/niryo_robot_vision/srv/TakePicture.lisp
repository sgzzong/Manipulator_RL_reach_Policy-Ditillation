...
(cl:defmethod cl:initialize-instance :after ((m <TakePicture-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TakePicture-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name niryo_robot_vision-srv:<TakePicture-request> is deprecated: use niryo_robot_vision-srv:TakePicture-request instead.")))

(cl:ensure-generic-function 'path-val :lambda-list '(m))
(cl:defmethod path-val ((m <TakePicture-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_vision-srv:path-val is deprecated.  Use niryo_robot_vision-srv:path instead.")
  (path m))
...
(cl:defmethod cl:initialize-instance :after ((m <TakePicture-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TakePicture-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name niryo_robot_vision-srv:<TakePicture-response> is deprecated: use niryo_robot_vision-srv:TakePicture-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <TakePicture-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader niryo_robot_vision-srv:success-val is deprecated.  Use niryo_robot_vision-srv:success instead.")
  (success m))
