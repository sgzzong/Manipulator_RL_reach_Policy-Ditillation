...
class HardwareStatus(genpy.Message):
  _md5sum = "9ebcaa8958a2bb480c482b67e9dd2b63"
...
"""
  ...
  __slots__ = ['header','rpi_temperature','hardware_version','hardware_state','connection_up','error_message','calibration_needed','calibration_in_progress','motor_names','motor_types','temperatures','voltages','hardware_errors','hardware_errors_message']
  _slot_types = ['std_msgs/Header','int32','string','int8','bool','string','bool','bool','string[]','string[]','int32[]','float64[]','int32[]','string[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_bB().pack(_x.hardware_state, _x.connection_up))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.hardware_state, _x.connection_up,) = _get_struct_bB().unpack(str[start:end])
